    ...
    <div className="bg-gradient-to-tr from-pink-100 via-purple-100 to-indigo-100 min-h-screen">
      ...
      <div className="hero bg-gradient-to-tr from-pink-100 via-purple-100 to-indigo-100 py-16">
        <div className="hero-content flex flex-col-reverse lg:flex-row items-center gap-12">
          {/* Text card */}
          <div className={`text-center lg:text-left max-w-lg glass-card p-8 rounded-2xl backdrop-blur-md border shadow-xl transition-all duration-500 ${editing ? "border-purple-300 ring-2 ring-purple-200" : "border-white/30 hover:shadow-2xl"}`}>
            {editing ? (
              <>
                <input
                  className="w-full text-3xl font-bold text-purple-700 mb-3 bg-white/70 border border-purple-200 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                ...
                <textarea
                  rows={4}
                  className="w-full text-base text-indigo-700 mb-4 bg-white/70 border border-purple-200 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400 resize-none"
              ...
              <>
                <h1 className="text-4xl md:text-5xl font-bold text-purple-700 mb-4">{pageContent.heroTitle}</h1>
                <p className="text-base md:text-lg text-indigo-700 mb-6">{pageContent.heroDescription}</p>
              </>
            )}
            <Link
              to="/about"
          ...
          <div className="relative w-full max-w-sm md:max-w-md lg:max-w-lg transform hover:rotate-1 transition-all duration-500">
            ...
            {editing && (
              <>
                ...
                <input ref={heroImageInputRef} type="file" accept="image/*" className="hidden" onChange={(e) => {
