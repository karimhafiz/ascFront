      ...
      {canEdit && (
        <div className="fixed top-24 right-6 z-50 flex gap-2">
          {!editing ? (
            ...
            <>
              <button onClick={handleCancel} className="px-4 py-2.5 rounded-full bg-white border border-gray-200 text-gray-600 text-sm font-medium shadow hover:bg-gray-50 transition-all cursor-pointer">
                Cancel
              </button>
              <button
                onClick={handleSave}
