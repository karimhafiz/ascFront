...
export default function VenueBookingDetail() {
  ...
  return (
    <PageContainer className="pb-12">
      <Helmet>
        <title>{venue?.name ? `Book ${venue.name}` : "Venue Booking"} | Ayendah Sazan</title>
        <meta
          name="description"
          content="Choose an available slot and continue to secure checkout for your venue booking."
        />
      </Helmet>
      ...
      <section className="page-section pt-6 md:pt-8">
        ...
        {venueLoading ? (
          ...
          <GlassCard className="rounded-[2rem] p-8 text-center">
            <p className="text-base-content/70">{venueError.message}</p>
          </GlassCard>
        ) : (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setFormData((prev) => ({ ...prev, numberOfAttendees: event.target.value }))
                      }
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setFormData((prev) => ({ ...prev, eventName: event.target.value }))
                      }
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      setFormData((prev) => ({ ...prev, eventDescription: event.target.value }))
                    }
                  />
                </div>
