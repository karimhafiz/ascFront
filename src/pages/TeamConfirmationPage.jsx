    ...
    return (
      <div className="min-h-screen bg-gradient-to-tr from-pink-100 via-purple-100 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <Link to="/" className="btn bg-purple-600 text-white hover:bg-purple-700 rounded-xl">Return to Home</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-tr from-pink-100 via-purple-100 to-indigo-100 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-purple-600 mt-2">Your team has been registered and payment received.</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg border border-white/50 p-6">
              ...
              <div className="space-y-1.5 text-sm text-purple-800">
                ...
                <p><span className="font-semibold">Manager:</span> {team.manager?.name}</p>
                <p><span className="font-semibold">Email:</span> {team.manager?.email}</p>
                <p><span className="font-semibold">Players:</span> {team.members?.length || 0} members</p>
              </div>
            </div>
                ...
                <div className="space-y-1.5 text-sm text-purple-800">
                  {event.date && (
                    <div className="flex items-center gap-2">
                      ...
                      <p>{new Date(event.date).toLocaleDateString("en-GB", { weekday: "long", day: "numeric", month: "long", year: "numeric" })}</p>
                    </div>
                  )}
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg border border-white/50 p-6">
              ...
              <ul className="space-y-2 text-sm text-purple-700">
                <li className="flex items-start gap-2"><span className="text-purple-400 mt-0.5">•</span> Prepare your team for the tournament</li>
                <li className="flex items-start gap-2"><span className="text-purple-400 mt-0.5">•</span> Check your email for additional instructions</li>
                <li className="flex items-start gap-2"><span className="text-purple-400 mt-0.5">•</span> Arrive 30 minutes before your scheduled time</li>
              </ul>
            </div>
