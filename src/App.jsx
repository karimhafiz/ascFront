...
const VenueBookingDetail = lazy(() => import("./pages/venues/VenueBookingDetail"));
const VenueFormPage = lazy(() => import("./pages/venues/VenueFormPage"));
const VenueSlotManagement = lazy(() => import("./pages/venues/VenueSlotManagement"));
const VenueRoot = lazy(() => import("./pages/venues/VenueRoot"));
...
const RequestPreview = lazy(() => import("./pages/admin/RequestPreview"));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        element: <ModeratorRoute />,
        children: [{ path: "requests/:id/preview", element: w(RequestPreview) }],
      },
