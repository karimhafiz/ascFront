      ...
      <div className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/40 px-4 sm:px-6 py-3 sm:py-4 shadow-sm">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center flex-shrink-0">
              <svg
          ...
          <div className="flex items-center gap-2">
            {editTo && (
              <Button variant="primary" to={editTo} className="shadow-md shadow-primary/20 text-sm">
            ...
            {createTo && (
              <Button
                variant="primary"
                to={createTo}
                className="shadow-md shadow-primary/20 text-sm"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
